...
vertex ImageColorInOut Feature4_capturedImageVertexTransform(ImageVertex in [[stage_in]]) {
    ImageColorInOut out;
...
fragment float4 Feature4_capturedImageFragmentShader(ImageColorInOut in [[stage_in]],
...
vertex ColorInOut Feature4_anchorGeometryVertexTransform(Vertex in [[stage_in]],
...
fragment float4 Feature4_anchorGeometryFragmentLighting(ColorInOut in [[stage_in]],
...
vertex CompositeColorInOut Feature4_compositeImageVertexTransform(const device CompositeVertex* cameraVertices [[ buffer(0) ]],
...
fragment half4 Feature4_compositeImageFragmentShader(CompositeColorInOut in [[ stage_in ]],
