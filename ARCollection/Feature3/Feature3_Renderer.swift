...
class Feature3_Renderer {
    ...
    func loadMetal() {
        ...
        let cameraVertexFunction = defaultLibrary.makeFunction(name: "Feature3_cameraVertexTransform")!
        let cameraFragmentFunction = defaultLibrary.makeFunction(name: "Feature3_cameraFragmentShader")!
        ...
        let anchorGeometryVertexFunction = defaultLibrary.makeFunction(name: "Feature3_anchorGeometryVertexTransform")!
        let anchorGeometryFragmentFunction = defaultLibrary.makeFunction(name: "Feature3_anchorGeometryFragmentLighting")!
        ...
        let geometryOutlineVertexFunction = defaultLibrary.makeFunction(name: "Feature3_anchorGeometryVertexTransform")!
        let geometryOutlineFragmentFunction = defaultLibrary.makeFunction(name: "Feature3_geometryOutlineFragment")!
        ...
        colorMap = try? textureLoader.newTexture(name: "feature3", scaleFactor: 1.0, bundle: nil, options: nil)
    }
