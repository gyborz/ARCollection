...
protocol Feature7_RenderDestinationProvider {
...
class Feature7_Renderer {
    ...
    var renderDestination: Feature7_RenderDestinationProvider
    ...
    init(session: ARSession, metalDevice device: MTLDevice, renderDestination: Feature7_RenderDestinationProvider) {
